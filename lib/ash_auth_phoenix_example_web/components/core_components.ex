defmodule AshAuthPhoenixExampleWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(AshAuthPhoenixExampleWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(AshAuthPhoenixExampleWeb.Gettext, "errors", msg, opts)
    end
  end
