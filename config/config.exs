...
config :ash_auth_phoenix_example, AshAuthPhoenixExampleWeb.Endpoint,
  url: [host: "localhost"],
  render_errors: [
    formats: [html: AshAuthPhoenixExampleWeb.ErrorHTML, json: AshAuthPhoenixExampleWeb.ErrorJSON],
    layout: false
  ],
  pubsub_server: AshAuthPhoenixExample.PubSub,
  live_view: [signing_salt: "3TRtd1/r"]

config :ash_auth_phoenix_example,
  ash_apis: [AshAuthPhoenixExample.Accounts]

config :ash_auth_phoenix_example,
  ecto_repos: [AshAuthPhoenixExample.Repo]
